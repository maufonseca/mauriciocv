...
object PortfolioRequester { //singleton declaration

  //Let it be here while not getting it from api
  fun getPortfolio(): ArrayList<AppSnippet> {

    val cedim = AppSnippet("CEDIMTech",
    ...
    val whatsgood = AppSnippet("WhatsGood",
    ...
    val queima = AppSnippet("Queima Diária",
    ...
    val mercadao = AppSnippet("Mercadão",
        "Tempo de trabalho no aplicativo: 6 meses",
    ...
    val delivve = AppSnippet("Delivve",
        "Tempo de trabalho no aplicativo: 6 meses",
    ...
    return arrayListOf(cedim, whatsgood, queima, whego, delivve, miss, mercadao)
  }
}
